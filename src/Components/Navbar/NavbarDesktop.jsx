...
const NavbarDesktop = () => {
  ...
  return (
    <div className=" w-full h-full flex justify-between items-center bg-[#0e0e0e] px-3">
      ...
      <div className="w-[20%] h-[70%] border-[0.5px] rounded-[50px] flex justify-center items-center border-[#1c1c1c] gap-8">
      ...
      <div className="w-[33%] flex justify-end items-center">
        <button className="py-2.5 px-20 mr-2 text-sm font-medium text-puple-500 bg-gray-200 focus:outline-none rounded-full border border-gray-200 hover:bg-gray-100 hover:text-purple-500" onClick={() => navigate("/create")}>Write</button>
        {authStatus === false
